 ...
 */
type LayoutState = { sidebar: number; workbench: number; details: number; narrow: boolean; narrowExpanded: boolean }
...
export function createLayoutStore(): EngineStoreHandle<LayoutState, LayoutActions>  {
  const handle = defineStore({
    init: (): LayoutState => ({ sidebar: SIDEBAR_DEFAULT, workbench: 0, details: 0, narrow: false, narrowExpanded: false }),
    actions: {
