...
| [`web-search/`](web-search/README.md) | One configurable search mount: native (DeepSeek, Claude, Gemini) and external (Exa, Brave, DuckDuckGo, Perplexity) backends behind one `provider` choice | registers on `ctx.web` |
