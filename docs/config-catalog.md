...
Source: [`packages/host/terminal-gateway/src/index.ts:46`](../packages/host/terminal-gateway/src/index.ts)
...
Source: [`packages/web/web-search/src/config.ts:18`](../packages/web/web-search/src/config.ts)
